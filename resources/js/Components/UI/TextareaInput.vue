...
<template>
    <div>
        ...
        <textarea
            ...
            :disabled="disabled"
            v-bind="$attrs"
            class="mt-1 block min-h-28 w-full rounded-md border-slate-300 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 disabled:bg-slate-100 disabled:text-slate-500"
